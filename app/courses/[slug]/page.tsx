...
export default async function Page({ params }: PageProps) {
  ...
  if (!course) {
    return (
      <div className="pt-32 pb-24 text-center max-w-xl mx-auto px-6 font-mono">
        <AlertCircle className="w-16 h-16 text-slate-400 mx-auto mb-6" />
        <h1 className="text-2xl font-bold text-slate-900 mb-3 font-sans">Course Not Found</h1>
        ...
        <Link 
          ...
          className="inline-flex items-center gap-2 px-6 py-3 bg-blue-900 text-white text-xs font-bold uppercase tracking-wider hover:bg-blue-800 transition-colors whitespace-nowrap"
        >
          <ArrowLeft size={16} />
          Back to Home
        </Link>
